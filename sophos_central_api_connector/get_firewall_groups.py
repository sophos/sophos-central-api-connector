...
# Global variables
page_size = "100"
api = "firewall_groups" # do not change
tenant= None
output = "stdout"
sourcetype_value = None


def get_firewall_groups(tenant_url_data, output, page_size, tenant):
    ...
    for ten_id, ten_item in tenant_url_data.items():
        ...
        logging.info("Attempting to get firewall group information")
        tenant_id = ten_id
...
def main():
    ...
    get_firewall_groups(tenant_url_data, output, page_size, tenant)
