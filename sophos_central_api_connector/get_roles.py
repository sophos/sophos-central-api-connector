...
# Global variables
page_size = None # do not change
api = "roles" # do not change
tenant= None
output = "stdout"
sourcetype_value = None


def get_roles(tenant_url_data, output, page_size, tenant):
    ...
    for ten_id, ten_item in tenant_url_data.items():
        ...
        logging.info("Attempting to get role information")
        tenant_id = ten_id
...
def main():
    ...
    get_roles(tenant_url_data, output, page_size, tenant)
