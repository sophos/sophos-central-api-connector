...
# Global variables
page_size = "100"
api = "firewall" # do not change
tenant= None
output = "stdout"
sourcetype_value = None


def get_firewalls(tenant_url_data, output, page_size, tenant):
    ...
    for ten_id, ten_item in tenant_url_data.items():
        ...
        logging.info("Attempting to get firewall information")
        tenant_id = ten_id
...
def main():
    ...
    get_firewalls(tenant_url_data, output, page_size, tenant)
