...
def event_failure(spl_event, poll, failed_id):
    ...
    if exists and poll:
        ...
        with open('sophos_central_api_connector/logs/failed_events.json', 'r') as fail_file:
        ...
        with open('sophos_central_api_connector/logs/failed_events.json', 'w') as new_fails:
